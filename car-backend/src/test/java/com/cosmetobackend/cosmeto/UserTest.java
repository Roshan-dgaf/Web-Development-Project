...
public class UserTest {
    ...
    public void saveUserTest() {
        ...
        user.setPassword("roshan123");
        user.setEmail("roshanbaidar1234@gmail.com");
        user.setContactNumber(944);
    ...
    public void updateUser(){
        ...
        user.setUsername("Kiran karmacharya");
        User userUpdated =  userRepository.save(user);

        Assertions.assertThat(userUpdated.getUsername()).isEqualTo("rojan baidar");
    }
